...
<div class = "grid md:grid-cols-3 ml-20">
  ...
  <div class="text-cyan-600 text-xl font-bold">
    ...
    frontend systems with React JS, Bootstrap,
     ...
     of frontend web apps with APIs.
    </p>
  </div>
  </div>
...
<div>
       ...
       <span class="block uppercase text-cyan-600 text-lg font-bold text-left mb-1 ml-3 mt-5">
            HTML
            </span>
            <span  class="block uppercase text-cyan-600 text-lg font-bold text-right mb-1 mr-10 mt-5">95%</span>
            </div>
      <div class="bg-blue-500 w-5/6 h-1.5" role="progressbar" aria-valuenow="1456" aria-valuemin="0" aria-valuemax="4550"></div>
      </div>
      </div>
      ...
      <div class = "m-5">
       ...
       <span class="block uppercase text-cyan-600 text-lg font-bold text-left mb-1 ml-3 mt-5">
            ...
            <span  class="block uppercase text-cyan-600 text-lg font-bold text-right mb-1 mr-10 mt-5">85%</span>
            </div>
      <div class="bg-blue-500 w-4/6 h-1.5" role="progressbar" aria-valuenow="1456" aria-valuemin="0" aria-valuemax="4550"></div>
      </div>
      </div>
